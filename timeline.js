...
links.Timeline.prototype.onMouseUp = function (event) {
    ...
    if (params.customTime) {
        ...
        //jquery hacking
        var t = params.target;
        var e =(t.classList.contains('timeline-event'))?(t[0] || t):t.querySelectorAll('.timeline-event')[0];
        var ec = (t.classList.contains('timeline-event-content'))?
            t.innerText:
            t.querySelectorAll('.timeline-event-content')[0].innerText;
